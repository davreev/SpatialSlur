    ...
    public static class Isosurface
    {
       ...
       */
        ...
        public static Mesh Evaluate(IList<double> values, double dx, double dy, double dz, int nx, int ny, int nz, double thresh)
        {
            ...
            Parallel.ForEach(Partitioner.Create(0, n - nxy), range =>
            {
                ...
                for (int index = range.Item1; index < range.Item2; index++, x++)
                {
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        double t = values[index + indexOffsets[i]];
        ...
        */
        ...
        public static Mesh Evaluate(IList<double> values, IList<Vec3d> normals, double dx, double dy, double dz, int nx, int ny, int nz, double thresh)
        {
            ...
            Parallel.ForEach(Partitioner.Create(0, n - nxy), range =>
            {
                ...
                for (int index = range.Item1; index < range.Item2; index++, x++)
                {
                    ...
                    {
                        voxelCorners[i] = p0 + cornerOffsets[i];
                        voxelNormals[i] = normals[index + indexOffsets[i]];
                    }
        ...
        public static Mesh Evaluate(IList<Vec3d> points, IList<double> values, int nx, int ny, int nz, double thresh)
        {
            ...
            Parallel.ForEach(Partitioner.Create(0, n - nxy), range =>
            {
                ...
                for (int index = range.Item1; index < range.Item2; index++, x++)
                {
                    ...
                    // set voxel corners
                    for (int i = 0; i < 8; i++)
                        voxelCorners[i] = points[index + indexOffsets[i]];
        ...
        private static void MeshVoxel(Vec3d[] corners, double[] values, int caseIndex, double thresh, Mesh result)
        {
        ...
        /// <param name="thresh"></param>
        /// <param name="result"></param>
        private static void MeshVoxel(Vec3d[] corners, double[] values, Vec3d[] normals, int caseIndex, double thresh, Mesh result)
        {
            var mv = result.Vertices;

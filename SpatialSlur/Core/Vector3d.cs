...
namespace SpatialSlur
{
    ...
    public partial struct Vector3d
    {
        ...
        /// <returns></returns>
        public bool ApproxEquals(Vector3d other, double epsilon = SlurMath.ZeroToleranced)
        {
            return

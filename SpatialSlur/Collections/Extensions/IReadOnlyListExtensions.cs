...
namespace SpatialSlur
{
    ...
    public static partial class IReadOnlyListExtensions
    {
        ...
        #region IReadOnlyList<Vector2d>

        /// <summary>
        /// 
        /// </summary>
        public static Vector2d Lerp(this IReadOnlyList<Vector2d> vectors, double factor)
        {
        ...
        #region IReadOnlyList<Vector3d>

        /// <summary>
        /// 
        /// </summary>
        public static Vector3d Lerp(this IReadOnlyList<Vector3d> vectors, double factor)
        {
            int last = vectors.Count - 1;
            factor = SlurMath.Fract(factor * last, out int i);
        ...
        public static void Lerp(this IReadOnlyList<double[]> vectors, double factor, double[] result)
        {
            ...
            if (i < 0)
                ...
                Vector.Lerp(vectors[i], vectors[i + 1], factor, result);
        }

...
namespace SpatialSlur.SlurCore
{
    ...
    public partial struct Vec2d
    {
        ...
        /// <returns></returns>
        public static implicit operator Vec2d(Vector2 vector)
        {
        ...
        /// <param name="vector"></param>
        /// <returns></returns>
        public static explicit operator Vector2(Vec2d vector)
        {
    ...
    public partial struct Vec3d
    {
        ...
        /// <param name="vector"></param>
        /// <returns></returns>
        public static implicit operator Vec3d(Vector3 vector)
        {
        ...
        /// <param name="vector"></param>
        /// <returns></returns>
        public static explicit operator Vector3(Vec3d vector)
        {

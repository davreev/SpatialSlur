...
namespace SpatialSlur.Fields
{
    ...
    internal class IDWField3dDouble : IDWField3d<double>
    {
        ...
        {
            /// <inheritdoc />
            public override IDWField3d<double> Create(double power, double epsilon = Constd.ZeroTolerance)
            {
        ...
        /// 
        /// </summary>
        public IDWField3dDouble(double power, double epsilon = Constd.ZeroTolerance)
            : base(power, epsilon)
        {
        }

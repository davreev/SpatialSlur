...
namespace SpatialSlur.Fields
{
    ...
    internal class IDWField3dVector3d : IDWField3d<Vector3d>
    {
        ...
        {
            /// <inheritdoc />
            public override IDWField3d<Vector3d> Create(double power, double epsilon = Constd.ZeroTolerance)
            {
        ...
        /// 
        /// </summary>
        public IDWField3dVector3d(double power, double epsilon = Constd.ZeroTolerance)
            : base(power, epsilon)
        {
        }

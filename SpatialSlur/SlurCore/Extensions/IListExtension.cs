...
namespace SpatialSlur.SlurCore
{
    ...
    public static partial class IListExtension
    {
        ...
        public static void Set<T>(this IList<T> list, IEnumerable<T> sequence)
        {
            if (list is T[] arr)
            {
                ArrayExtension.Set(arr, sequence);
                return;
            }
        ...
        public static void SetRange<T>(this IList<T> list, T value, int index, int count)
        {
            if (list is T[] arr)
            {
                ArrayExtension.SetRange(arr, value, index, count);
                return;
            }
        ...
        public static void SetRange<T>(this IList<T> list, IReadOnlyList<T> other, int thisIndex, int otherIndex, int count)
        {
            ...
            {
                ArrayExtension.SetRange(arr0, arr1, thisIndex, otherIndex, count);
                return;
            }
        ...
        public static void SetRange<T>(this IList<T> list, IEnumerable<T> sequence, int index, int count)
        {
            if(list is T[] arr)
            {
                ArrayExtension.SetRange(arr, sequence, index, count);
                return;
            }
        ...
        public static void SetSelection<T>(this IList<T> list, T value, IEnumerable<int> indices)
        {
            if (list is T[] arr)
            {
                ArrayExtension.SetSelection(arr, value, indices);
                return;
            }
        ...
        public static void SetSelection<T>(this IList<T> list, IList<T> other, IList<int> indices)
        {
            ...
            {
                ArrayExtension.SetSelection(arr0, arr1, arr2);
                return;
            }
        ...
        public static void Shuffle<T>(this IList<T> list, Random random)
        {
            if (list is T[] arr)
            {
                ArrayExtension.Shuffle(arr, random);
                return;
            }
        ...
        public static void Shuffle<T>(this IList<T> list, Random random, int index, int count)
        {
            if (list is T[] arr)
            {
                ArrayExtension.Shuffle(arr, random, index, count);
                return;
            }
        ...
        public static void Shift<T>(this IList<T> list, int offset, int from, int to)
        {
            if (list is T[] arr)
            {
                ArrayExtension.Shift(arr, offset, from, to);
                return;
            }
        ...
        public static void Reverse<T>(this IList<T> list, int from, int to)
        {
            if (list is T[] arr)
            {
                ArrayExtension.Reverse(arr, from, to);
                return;
            }
        ...
        {
            if (list is T[] arr)
                return ArrayExtension.Swim(arr, match);
        ...
        {
            if (items is T[] arr)
                return ArrayExtension.QuickSelect(arr, n, from, to);
        ...
        {
            if (items is T[] arr)
                return ArrayExtension.QuickSelect(arr, n, from, to, compare);
            ...
            where K : IComparable<K>
        {
            if (keys is K[] arr0 && values is V[] arr1)
                return ArrayExtension.QuickSelect(arr0, arr1, n, from, to);

...
namespace SpatialSlur.SlurCore
{
    ...
    public struct Mat3d
    {
        ...
        /// <summary></summary>
        public static Mat3d Identity = new Mat3d(1.0);
        ...
        public static implicit operator Mat3d(Rotate2d rotate)
        {
            var m = Identity;
            m.Column0 = rotate.X;
            m.Column1 = rotate.Y;
        ...
        public static implicit operator Mat3d(Orient2d orient)
        {
            var m = new Mat3d();
        ...
        public static implicit operator Mat3d(Transform2d transform)
        {
            var m = new Mat3d();
        ...
        /// </summary>
        /// <param name="rotate"></param>
        public static implicit operator Mat3d(Rotate3d rotate)
        {
            var m = Identity;
            m.Column0 = rotate.X;
            m.Column1 = rotate.Y;
        ...
        /// </summary>
        /// <returns></returns>
        public static Mat3d operator *(Mat3d matrix, double scalar)
        {
            matrix.M00 *= scalar;
            matrix.M01 *= scalar;
            matrix.M02 *= scalar;
        ...
        /// </summary>
        /// <returns></returns>
        public static Vec3d operator *(Mat3d matrix, Vec3d vector)
        {
            return new Vec3d(
        ...
        /// </summary>
        /// <returns></returns>
        public static Mat3d operator *(Mat3d m0, Mat3d m1)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static Mat3d operator -(Mat3d matrix)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static Vec3d Multiply(ref Mat3d matrix, Vec3d vector)
        {
            return new Vec3d(
                Vec3d.Dot(vector, matrix.Row0),
                Vec3d.Dot(vector, matrix.Row1),
        ...
        /// </summary>
        /// <returns></returns>
        public static Mat3d Multiply(ref Mat3d m0, ref Mat3d m1)
        {
            var m2 = new Mat3d();

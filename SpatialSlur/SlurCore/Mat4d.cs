...
namespace SpatialSlur.SlurCore
{
    ...
    public struct Mat4d
    {
        ...
        /// <summary></summary>
        public static Mat4d Identity = new Mat4d(1.0);
        ...
        public static implicit operator Mat4d(Mat3d matrix)
        {
            var m = Identity;
        ...
        public static implicit operator Mat4d(Rotate3d rotate)
        {
            var m = Identity;
            m.Column0 = rotate.X;
            m.Column1 = rotate.Y;
        ...
        public static implicit operator Mat4d(Orient3d orient)
        {
            var m = new Mat4d();
        ...
        public static implicit operator Mat4d(Transform3d transform)
        {
            var m = new Mat4d();
        ...
        /// </summary>
        /// <returns></returns>
        public static Mat4d operator *(Mat4d matrix, double scalar)
        {
            matrix.M00 *= scalar;
            matrix.M01 *= scalar;
            matrix.M02 *= scalar;
        ...
        /// </summary>
        /// <returns></returns>
        public static Vec4d operator *(Mat4d matrix, Vec4d vector)
        {
            return new Vec4d(
        ...
        /// </summary>
        /// <returns></returns>
        public static Mat4d operator *(Mat4d m0, Mat4d m1)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static Mat4d operator -(Mat4d matrix)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static Vec4d Multiply(ref Mat4d matrix, Vec4d vector)
        {
            return new Vec4d(
                Vec4d.Dot(vector, matrix.Row0),
                Vec4d.Dot(vector, matrix.Row1),
        ...
        /// </summary>
        /// <returns></returns>
        public static Mat4d Multiply(ref Mat4d m0, ref Mat4d m1)
        {
            var m2 = new Mat4d();

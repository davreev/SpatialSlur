...
namespace SpatialSlur.SlurCore
{
    ...
    public static partial class IEnumerableExtension
    {
        ...
        /// <returns></returns>
        public static HeGraph3d ToHeGraph(this IEnumerable<Line> lines, double tolerance = SlurMath.ZeroTolerance, bool allowMultiEdges = false, bool allowLoops = false)
        {
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static HeMesh3d ToHeMesh(this IEnumerable<Polyline> polylines, double tolerance = SlurMath.ZeroTolerance)
        {

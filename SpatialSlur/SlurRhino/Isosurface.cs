    ...
    public static class Isosurface
    {
        ...
        public static class MarchingCubes
        {
           ...
           */
            ...
            /// <param name="threshold"></param>
            /// <returns></returns>
            public static Mesh Evaluate(double[] values, Vec3d origin, Vec3d scale, int countX, int countY, int countZ, double threshold)
            {
            ...
            public static Mesh Evaluate(double[] values, int countX, int countY, int countZ, double threshold)
            {
                ...
                Parallel.ForEach(Partitioner.Create(0, n - nxy), range =>
                {
                    ...
                    for (int i = range.Item1; i < range.Item2; i++, x++)
                    {
                        ...
                        int caseIndex = 0;
                        for (int j = 0; j < 8; j++)
                            if (values[i + indexOffsets[j]] < threshold) caseIndex |= (1 << j);
                        ...
                        // mesh voxel
                        MeshVoxel(voxelVerts, voxelVals, caseIndex, threshold, chunk);
                    }
            ...
            /// <param name="threshold"></param>
            /// <returns></returns>
            public static Mesh Evaluate(GridField3d<double> field, Vec3d[] normals, double threshold)
            {
            ...
            /// <param name="threshold"></param>
            /// <returns></returns>
            public static Mesh Evaluate(double[] values, Vec3d[] normals, Grid3d grid, double threshold)
            {
            ...
            /// <param name="threshold"></param>
            /// <returns></returns>
            public static Mesh Evaluate(double[] values, Vec3d[] normals, Vec3d origin, Vec3d scale, int countX, int countY, int countZ, double threshold)
            {
            ...
            /// <param name="threshold"></param>
            /// <returns></returns>
            public static Mesh Evaluate(double[] values, Vec3d[] normals, int countX, int countY, int countZ, double threshold)
            {
                int nxy = countX * countY;
                int n = nxy * countZ;
                int[] indexOffsets = GetIndexOffsets(countX, nxy);
                ...
                Parallel.ForEach(Partitioner.Create(0, n - nxy), range =>
                {
                    ...
                    for (int i = range.Item1; i < range.Item2; i++, x++)
                    {
                        ...
                        // mesh voxel
                        MeshVoxel(voxelVerts, voxelVals, voxelNorms, caseIndex, threshold, chunk);
                    }
            ...
            /// <param name="threshold"></param>
            /// <returns></returns>
            public static Mesh Evaluate(IReadOnlyList<double[]> values, Vec3d origin, Vec3d scale, int countX, int countY, double threshold)
            {
                    ...
                    for (int z = range.Item1; z < range.Item2; z++)
                    {
                        ...
                        for (int y = 0; y < countY - 1; y++)
                        {
                            for (int x = 0; x < countX - 1; x++)
                            {
                                ...
                                for (int i = 0; i < 4; i++)
                                {
                                    if (vals0[index + indexOffsets[i]] < threshold) caseIndex |= (1 << i);
                                    if (vals1[index + indexOffsets[i]] < threshold) caseIndex |= (1 << (i + 4));
                                }
                                ...
                                // mesh voxel
                                MeshVoxel(voxelVerts, voxelVals, caseIndex, threshold, layer);
                            }
                        }
                    }
            ...
            /// <param name="threshold"></param>
            /// <returns></returns>
            public static Mesh Evaluate(Vec3d[] points, double[] values, int countX, int countY, int countZ, double threshold)
            {
                int nxy = countX * countY;
                int n = nxy * countZ;
            ...
            private static void MeshVoxel(Vec3d[] corners, double[] values, int caseIndex, double threshold, Mesh result)
            {
                var mv = result.Vertices;
                var mf = result.Faces;
                int nv = mv.Count;
                ...
                for (int i = 0; i < edges.Length; i++)
                {
                    ...
                    // interpolate edge
                    double t = SlurMath.Normalize(threshold, values[v0], values[v1]);
                    Vec3d p = Vec3d.Lerp(corners[v0], corners[v1], t);
                    mv.Add(p.X, p.Y, p.Z);
                }
            ...
            /// <param name="threshold"></param>
            /// <param name="result"></param>
            private static void MeshVoxel(Vec3d[] corners, double[] values, Vec3d[] normals, int caseIndex, double threshold, Mesh result)
            {
                var mv = result.Vertices;
                var mn = result.Normals;
                var mf = result.Faces;
                int nv = mv.Count;

...
namespace SpatialSlur.SlurField
{
    ...
    /// </summary>
    [Serializable]
    public abstract class MeshField : IMeshField
    {
    ...
    public abstract class MeshField<T> : MeshField, IMeshField<T>, IField2d<T>, IField3d<T>, IDiscreteField3d<T>
        where T : struct
    {
        ...
        /// </summary>
        /// <returns></returns>
        protected abstract MeshField<T> DuplicateBase(bool copyValues);

 ...
 * Notes
 * 
 * TODO consider pooling nodes internally
 */
...
namespace SpatialSlur.Meshes
{
        ...
        where T : Node
    {
        ...
        public static implicit operator ReadOnlyArrayView<T>(NodeList<T> source)
        {
        ...
        /// 
        /// </summary>
        private protected ArrayView<T> AsView()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ReadOnlyArrayView<T> AsReadOnlyView()
        {
        ...
        {
            return _items.AsView(_count).GetEnumerator();
        }
    ...
    [Serializable]
    public class NodeList<T, E> : NodeList<T>
        where T : Node<T, E>
        where E : Halfedge<E>
    {
        /// <summary>

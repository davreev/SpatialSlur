...
namespace SpatialSlur.Meshes.Impl
{
    ...
    public abstract class HeNode
    {
        ...
        public static implicit operator int(HeNode element)
        {
    ...
    [Serializable]
    public abstract class HeNode<T> : HeNode
        where T : HeNode<T>
    {
        #region Static Members
    ...
    [Serializable]
    public abstract class HeNode<T, E> : HeNode<T>
       where T : HeNode<T, E>
       where E : Halfedge<E>
    {
        private E _first;
